...
namespace Iancau_Maria_Lab2.Migrations
{
    ...
    [Migration("20241109112511_AddBorrowingIDColumn")]
    partial class AddBorrowingIDColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Iancau_Maria_Lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Iancau_Maria_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Iancau_Maria_Lab2.Models.Borrowing", b =>
                {
                    b.HasOne("Iancau_Maria_Lab2.Models.Book", "Book")
                        .WithOne("Borrowing")
                        .HasForeignKey("Iancau_Maria_Lab2.Models.Borrowing", "BookID")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Iancau_Maria_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
